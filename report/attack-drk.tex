...
This however doesn't tell anything about what this page is actually being used for.
...
The address ranges into which the kernel and the modules are mapped are different and don't overlap.
...
Knowing the amount modules and their sizes makes it possible to uniquely identify some of the modules \cite{drk}.
